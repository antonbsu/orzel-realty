...
export const getSalesBlockQuery = groq`*[_type == "property" && purpose == "Sprzedaż" ]  | order(_createdAt desc)[0..5] {
    _id,
    name,
    slug,
    images,
...
export const getAllSalesQuery = groq`*[_type == "property" && purpose == "Sprzedaż" ]  | order(_createdAt desc) {
    _id,
    name,
    slug,
    images,
